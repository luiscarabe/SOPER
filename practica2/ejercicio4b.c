 ...
 * con el resultado, el numero de fila multiplicada y el numero de fila por el que va el otro proceso. 
 ...
 * de multiplicacion de matrices. Antes de finalizar, espera a que los dos hilos generados acaben. La 
 * diferencia con el main del codigo anterior radica en que en este caso los hilos se comunican entre si. 
...
int main(int argc, char* argv[]){
    ...
    /*Se garantiza el acceso de un hilo al otro*/
